...
def new_win():
    ...
    model = load_model(
        'C:/Users/LAPTOP/Desktop/Neural Project/Model/NNPractical.h5')
    classes = {
        0: 'airplane',
        1: 'car',
        2: 'bird',
    ...
    def show_classify_button(file_path):
        ...
        classify_btn.configure(background="#E86615",
    ...
    def classify(file_path):
        ...
        sign = classes[pred]
        print(sign)
        lable.configure(foreground='#E86615', text=sign)
...
# *****************************#
    ...
    path1 = "C:/Users/LAPTOP/Desktop/Neural Project/Assets/Upload_photo.png"
    ...
    label = tk.Label(top, background="#272727", image=tk_imagee)
    label.pack(pady=10)
    label.pack()

    # clsass
    lable = Label(top, background="#272727", font=('arial', 15, 'bold'))
...
label1 = Label(w, text='PROGRAMEDD', fg='#E86615',
...
image_a = ImageTk.PhotoImage(Image.open(
    'C:/Users/LAPTOP/Desktop/Neural Project/Assets/c2.png'))
image_b = ImageTk.PhotoImage(Image.open(
    'C:/Users/LAPTOP/Desktop/Neural Project/Assets/c1.png'))
